 ...
 * log_record.h
 * 
 * log record struct does not follow bytes layout below !!!
 * 
 * 
...
all others == fill in when init log 
prevLSN == fill in when init log    (ordering of 1 txn, wont change)
LSN == fill in when append log      (ordering of all txns)
*/

public:
  
  // constructor for invalid log entry
  LogRecord()
...
//////////////////////////////////////////////////////////////////////////////////////////
  ...
  inline page_id_t GetPrevPageId() { return prev_page_id_; }
...
private:
  ...
  lsn_t prev_lsn_ = INVALID_LSN; // of same txn == txn->latestLSN 
